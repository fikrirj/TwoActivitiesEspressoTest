...
package com.example.android.twoactivitiesespressotest;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.android.twoactivitiesespressotest.MESSAGE";
    ...
    public void launchSecondActivity(View view) {
        ...
        Intent intent = new Intent(this, com.example.android.twoactivitiesespressotest.SecondActivity.class);
        String message = "";
        if (mMessage != null) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TEXT_REQUEST) {
            if (resultCode == RESULT_OK) {
                String reply = data.getStringExtra(com.example.android.twoactivitiesespressotest.SecondActivity.EXTRA_REPLY);
