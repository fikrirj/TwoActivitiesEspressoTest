...
public class SecondActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY =
            "com.example.android.twoactivitiesespressotest.REPLY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = intent.getStringExtra(com.example.android.twoactivitiesespressotest.MainActivity.EXTRA_MESSAGE);
